    ...
    },
    {
        ...
        options: {
            ...
            handler: async (request, h) => {
                ...
                request.yar.flash('success', 'everything saved OK');
    ...
    },
    {
        ...
        options: {
            ...
            handler: async (request, h) => {
              ...
              let formErrors = request.yar.get('formErrors' + target) || {};
              request.yar.clear('formErrors' + target);
              ...
              for (var [key, val] of Object.entries(robot)) {
                ...
                if (key in formErrors) {
                  fields[key].__val = formErrors[key].value;
                  fields[key].__errmsg = formErrors[key].message;
                }
              }
              const form = {
                ...
                failAction: (request, h, error) => {
                  ...
                  if (error.isJoi) {
                    const formErrors = error.details.reduce((acc, curr) => {
                      request.yar.flash('danger', curr.message, false);
                    ...
                    request.yar.set('formErrors' + target, formErrors);
                  }
                  else {
                    request.yar.flash(
                        'danger', 'there was an error in your form', true);
                  }
